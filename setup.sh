...
#             (bin/wallset replaces it, bin/wallpaper draws it; both
#             read the image by content, whatever the suffix)
...
# (assets/wallpaper.png; swaybg and magick read the format from the
# content, so the recorded name stays wallpaper.jpg), copied once and
# never again: whatever the file becomes afterwards is the user's
# choice. It runs before the
...
seed_wallpaper() {
    ...
    install -D -m 644 "$REPO/assets/wallpaper.png" "$wall"
}
